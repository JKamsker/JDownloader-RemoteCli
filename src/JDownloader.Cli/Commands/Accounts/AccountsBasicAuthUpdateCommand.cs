...
public sealed class AccountsBasicAuthUpdateCommand : DeviceApiCommand<AccountsBasicAuthUpdateSettings>
{
    private readonly IMyJdTransport _transport;
    private readonly IConfirmationGuard _confirmationGuard;

    public AccountsBasicAuthUpdateCommand(
    ...
    protected override async Task<CommandOutput> ExecuteCoreAsync(
        ...
        AccountsBasicAuthUpdateSettings settings,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var password = await SecretInput.ReadSecretAsync(
            ...
            settings.Json,
            settings.Quiet,
            "accounts basic-auth update requires exactly one of --password <password> or --password-stdin.",
